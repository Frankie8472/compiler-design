...
public class ReachingDefinitionDataFlowAnalysis extends ForwardDataFlowAnalysis<Set<Stmt>> {
    private Map<BasicBlock, Set<Stmt>> gen;
    private Map<BasicBlock, Set<Stmt>> kill;
    private Map<Var, Set<Stmt>> varDefMap;

    public ReachingDefinitionDataFlowAnalysis(ControlFlowGraph cfg) {
        super(cfg);
        generateVarDefMap();
        generateDefKillSets();
        iterate();
