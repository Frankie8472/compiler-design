...
public abstract class Ast {
	...
	/**
	 * The list of children AST nodes. Typically, this list is of a fixed size: its
	 * contents can also be accessed using the various accessors defined on the Ast
	 * subtypes.
	 * 
	 * <p>
	...
	/**
	 * Returns a copy of the list of children for this node. The result will never
	...
	/**
	 * Returns a new list containing all children AST nodes that are of the given
	 * type.
	 */
	...
	public static class BinaryOp extends LeftRightExpr {
		...
		public static enum BOp {
			...
			/**
			 * Note that this method ignores short-circuit evaluation of boolean AND/OR.
			 * 
	...
	public static class Var extends LeafExpr {
		...
		/**
		 * Use this static function to build an instance after the semantic phase; it
		 * fills in the {@link #type} and {@link #sym} fields.
		 */
	...
	public static class MethodCallExpr extends Expr {
		...
		/**
		 * Returns all arguments to the method, <b>including the receiver.</b> i.e, for
		 * a method call {@code a.b(c,d)} returns {@code [a, c, d]}
		 */
		...
		/**
		 * Returns all arguments to the method, without the receiver. i.e, for a method
		 * call {@code a.b(c,d)} returns {@code [c, d]}
		 */
