...
public abstract class Ast {
	...
	/** 
	 * Returns the number of registers this Ast and its children need.
	 */
	...
	public static class BinaryOp extends LeftRightExpr {
		...
		//Register count dependent on left and right subtree according to algorithm from slides
		@Override
		public int registerCount()
		{
			int rightNeed = right().registerCount();
			int leftNeed = left().registerCount();
			if (rightNeed == leftNeed) return rightNeed+1;
			else return Math.max(leftNeed, rightNeed);
		}
	...
	public static class UnaryOp extends ArgExpr {
		...
		//number of registers of child needed
		@Override
		public int registerCount()
		{
			return children().get(0).registerCount();
		}
	}
	...
	public static class Assign extends Stmt {
		...
		// need number of registers of right child
		@Override
		public int registerCount()
		{
			return right().registerCount();
		}
