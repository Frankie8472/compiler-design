...
public interface JavaliVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code IDENTIFIERACCESS}
	 * labeled alternative in {@link JavaliParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	 ...
	 * @return the visitor result
	 */
	T visitUNARYOP(JavaliParser.UNARYOPContext ctx);
	/**
	 * Visit a parse tree produced by the {@code BINARYOP1}
	 * labeled alternative in {@link JavaliParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBINARYOP1(JavaliParser.BINARYOP1Context ctx);
	/**
	 * Visit a parse tree produced by the {@code BINARYOP2}
	 * labeled alternative in {@link JavaliParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBINARYOP2(JavaliParser.BINARYOP2Context ctx);
	/**
	 * Visit a parse tree produced by the {@code BINARYOP3}
	 * labeled alternative in {@link JavaliParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBINARYOP3(JavaliParser.BINARYOP3Context ctx);
	/**
	 * Visit a parse tree produced by the {@code BINARYOP4}
	 * labeled alternative in {@link JavaliParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBINARYOP4(JavaliParser.BINARYOP4Context ctx);
	/**
	 * Visit a parse tree produced by the {@code BINARYOP5}
	 * labeled alternative in {@link JavaliParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBINARYOP5(JavaliParser.BINARYOP5Context ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code BINARYOP6}
	 * labeled alternative in {@link JavaliParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBINARYOP6(JavaliParser.BINARYOP6Context ctx);
	/**
